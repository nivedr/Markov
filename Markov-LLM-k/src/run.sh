...
python main.py --p 0.8 --q 0.8 --n_layer 2 --n_head 1 --n_embd 50 --sequence_length 200 --order 1 --data_in_ram --iterations 20000 --batch_size 8 --acc_steps 1 --transition random
