...
python main.py --p 0.8 --q 0.8 --n_layer 2 --n_head 2 --n_embd 16 --sequence_length 200 --order 2 --data_in_ram --iterations 20000 --batch_size 8 --acc_steps 1 --transition interpolation_random --interpolation 1
