...
def get_args():
    ...
    parser.add_argument('--tokenizer', default='LZW', choices=config.registered_formats())
    parser.add_argument('--max_dict_size', default=15, choices=config.registered_formats())
